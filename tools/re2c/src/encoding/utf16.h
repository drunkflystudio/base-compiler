...
static const/*expr*/ uint32_t MAX_1WORD_RUNE = 0xFFFFu;
static const/*expr*/ uint32_t MIN_LEAD_SURR = 0xD800u;
static const/*expr*/ uint32_t MIN_TRAIL_SURR = 0xDC00u;
static const/*expr*/ uint32_t MAX_TRAIL_SURR = 0xDFFFu;
